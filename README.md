...
The `Cloudstack` multi-component plugin can be used with HashiCorp [Packer](https://www.packer.io)
...
directory. Upon successful compilation, a `packer-plugin-cloudstack` plugin
